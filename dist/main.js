...
const signInSectionCreation = (() => {
    ...
    const SignInObjectList = {
      ...
      const formElementContentList = () => {
        ...
        let label1 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
            tag:SignInObjectList.signInTags[3],
            for:SignInObjectList.signInFors[0],
            htmlString:SignInObjectList.signInHTMLs[1],
        })

        let label2 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
            tag:SignInObjectList.signInTags[3],
            for:SignInObjectList.signInFors[1],
            htmlString:SignInObjectList.signInHTMLs[2],
        })

        let input1 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
        ...
        let input2 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
            tag:SignInObjectList.signInTags[4],
            type:SignInObjectList.signInTypes[0],
        ...
        let input3 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
            tag:SignInObjectList.signInTags[4],
            type:SignInObjectList.signInTypes[1],
            value:SignInObjectList.signInValues[0],
        })

        let input4 = _global__WEBPACK_IMPORTED_MODULE_0__.globaljs.newElement({
            tag:SignInObjectList.signInTags[4],
            type:SignInObjectList.signInTypes[1],
